...
couleurProduit.innerHTML = panier[i].colorChoiceKanap;
...
function deleteItemFromCart () {
    ...
    let colorProduitDelete = panier[i].colorChoiceKanap;
    panier = panier.filter( a => a.idKanap !== idProduitDelete && a.colorChoiceKanap !== colorProduitDelete);
    localStorage.setItem("panier_localStorage", JSON.stringify(panier));
